...
class SparentsController extends AppController
{
    ...
    //method for deactivating a parent
    public function deactivate($parentid){
     $parent = $this->Sparents->get($parentid);
     $parent->status = "deactivated";
     if($this->Sparents->save($parent)){
          $this->Flash->success('The parent account has been deactivated');
          return $this->redirect(['controller' => 'Admins', 'action' => 'viewparents']);
    ...
    //method for activating a deactivaed parent
    public function activate($parentid){
     $parent = $this->Sparents->get($parentid);
