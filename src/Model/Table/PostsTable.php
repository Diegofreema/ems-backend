...
//        $validator
//            ->scalar('allowcomments')
//            ->maxLength('allowcomments', 8)
//            ->notEmptyString('allowcomments');
        ...
        $validator
            ->scalar('postdetails')
            ->maxLength('postdetails', 900)
            ->requirePresence('postdetails', 'create')
            ->notEmptyString('postdetails');
...
//            ->notEmptyString('status');
    ...
    {
        $rules->add($rules->existsIn('postcategory_id', 'Postcategories'), ['errorField' => 'postcategory_id']);
