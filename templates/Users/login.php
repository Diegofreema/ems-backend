            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center py-4">
                <div class="login-box p-4 shadow rounded bg-white w-100" style="max-width: 420px;">
                    <div class="text-center mb-4">
                        <a href="/">  
<?=  $this->Html->image("logolta.png",['alt'=>SCHOOL,'style'=>'width: 80px;']) ?>  </a>
       ...
       'placeholder'=>'email address']) ?>
				 ...
				 <?= $this->Form->control('password', ['label'=>false,'class'=>'form-control bi bi-lock','required',
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                         ...
                         <?=  $this->Html->link(' Forgot password?', ['controller' => 'Users', 'action' => 'forgotpassword'], ['title' => 'forgot password', 'class' => 'text-decoration-none'])?>

                        </div>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary" style="background-color: rgba(0, 0, 128, 0.9);">Sign In</button>
                        </div>
                          <?= $this->Form->end() ?>
                    </div>
                </div>
