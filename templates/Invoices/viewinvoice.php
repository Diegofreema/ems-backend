            ...
            <div class="col-sm-12">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><?= $this->Html->link(' Dashboard', ['controller' => 'Users', 'action' => 'dashboard', $this->GenerateUrl('Dashboard')], ['title' => 'Dashboard'])
                        ?></li>
                    <li class="breadcrumb-item"><?= $this->Html->link('Invoices', ['controller' => 'Invoices', 'action' => 'index'], ['title' => 'invoices']) ?></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <?=$this->Html->image($settings->logo, ['alt' => 'LOGO', 'class' => 'inv-logo','width'=>130])?>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>Department: <?= $invoice->student->department->name . (!empty($invoice->student->class_arm) ? ' - ' . $invoice->student->class_arm->arm_name : '') ?></li>
