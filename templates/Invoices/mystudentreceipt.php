...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">My Kid Receipt - <?= $transaction->student->fname.' '.$transaction->student->lname ?></h3>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><?= $this->Html->link(' Invoices', ['controller' => 'Sparents', 'action' => 'mykidinvoices', $this->GenerateUrl('My Kid Invoices')], ['title' => 'My Kid Invoices'])
                        ?></li>
                    <li class="breadcrumb-item active">My Kid Receipt</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>Class: <?= $transaction->student->department->name ?></li>
