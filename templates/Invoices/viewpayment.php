        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><?= $this->Html->link('Manage Transactions', ['controller' => 'Transactions', 'action' => 'index'], ['title' => 'Manage Transactions']) ?></li>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>Class: <?= $transaction->student->department->name . (!empty($transaction->student->class_arm) ? ' - ' . $transaction->student->class_arm->arm_name : '') ?></li>
