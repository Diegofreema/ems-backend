...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Complete Your Profile</h3>
                <ul class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <?= $this->Form->control('country_id', ['options' => $countries, 'label' => false, 'class' => 'form-control form-control-user2', 'placeholder' => 'country', 'empty' => 'Select Country']) ?>
                                </div>
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <?= $this->Form->control('state_id', ['options' => $states, 'label' => false, 'class' => 'form-control form-control-user2', 'placeholder' => 'state', 'empty' => 'Select State']); ?>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <?= $this->Form->control('passports', ['label' => 'Passport', 'type' => 'file', 'class' => 'form-control form-control-user2', 'placeholder' => 'Upload passport']); ?>
                                </div>
                                <div class="col-sm-4">
                                    <?php
