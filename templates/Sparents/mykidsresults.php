...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">My Kid Results</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item">
                        <?= $this->Html->link(' Dashboard', ['controller' => 'Sparents', 'action' => 'dashboard', $this->GenerateUrl('Parent dashboard')], ['title' => 'Parent dashboard']) ?>
                    </li>
                    <li class="breadcrumb-item active">My Kid Results</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="card-body" style="padding: 20px;">
                    <div class="table-responsive">
                        ...
                        <div style="clear: both; margin-top: 30px; text-align: right;">
                            ...
                            <a href="<?= $this->Url->build(['controller' => 'Sparents', 'action' => 'downloadPdf', $student->id, $session_id ?? '', $semester_id ?? '']) ?>" class="btn btn-primary" target="_blank">
