...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">My Kid Invoice - <?= $student->fname.' '.$student->lname ?></h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><?= $this->Html->link(' Dashboard', ['controller' => 'Sparents', 'action' => 'dashboard', $this->GenerateUrl('Parent dashboard')], ['title' => 'Parent dashboard'])
                        ?></li>
                    <li class="breadcrumb-item"><?= $this->Html->link(' Invoices', ['controller' => 'Sparents', 'action' => 'mykidinvoices', $this->GenerateUrl('My Kid Invoices')], ['title' => 'My Kid Invoices'])
                        ?></li>
                    <li class="breadcrumb-item active">My Kid Invoice</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><span>Address: <?= ucfirst($student->address)?></span></li>
                    ...
                    <div>
                      <br />  <br />  <br />
                        <div class="invoice-info">
                            ...
                            <p class="text-muted">Please note that payment can also be made at all commercial bank branches nationwide<br />
...
<!--	<div class="col-sm-12 float-left">
             ...
             <!--?= $this->Html->link(__(' Pay Online - PayStack'), ['controller'=>'Transactions','action' => 'gotopaystack', $student->user->username,
                ...
                $transaction->payref,$transaction->id],
