...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Test Results for <?= h($student->fname . ' ' . $student->lname) ?></h3>
                <ul class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="result-info">
                                ...
                                <p><strong>Subject:</strong> <?= h($assignment->setassignment->subject->name) ?></p>
                                    ...
                                    <div class="answer-options mb-3">
                                        ...
                                        if (!empty($questionOptions)):
                                            foreach ($questionOptions as $optionIndex => $option): ?>
                                                <div class="option-result p-2 mb-2 border rounded <?= $option->id == $answer->selected_option_id ? 'bg-light' : '' ?>">
                                                    ...
                                                    <?php if ($option->id == $answer->selected_option_id): ?>
                                                        <span class="badge badge-primary ml-2">Student's Answer</span>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endforeach; 
                                        else: ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="result-status">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <small class="text-muted d-block mt-1">Theory questions require manual review by teacher.</small>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fa fa-comments"></i> Parent Feedback & Notes
                    </h6>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <strong><i class="fa fa-lightbulb-o"></i> Suggestions for Improvement:</strong><br>
                        <ul class="mb-0 mt-2">
                            <?php if ($percentage < 50): ?>
                                <li>Consider reviewing the subject material with your child</li>
                                <li>Practice similar questions to improve understanding</li>
                                <li>Schedule extra study time for challenging topics</li>
                            <?php elseif ($percentage < 80): ?>
                                <li>Good effort! Focus on the questions that were answered incorrectly</li>
                                <li>Review the correct answers to understand mistakes</li>
                                <li>Encourage your child to ask questions about unclear concepts</li>
                            <?php else: ?>
                                <li>Excellent performance! Keep up the good work</li>
                                <li>Consider challenging your child with more advanced material</li>
                                <li>Maintain the current study routine</li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    
                    <?php if (isset($assignment->teacher_comments) && !empty($assignment->teacher_comments)): ?>
                        <div class="teacher-feedback">
                            <h6><strong>Teacher Comments:</strong></h6>
                            <div class="alert alert-success">
                                <i class="fa fa-user-tie"></i> <?= nl2br(h($assignment->teacher_comments)) ?>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <div class="row mt-4">
        <div class="col-md-12 text-center">
            <?= $this->Html->link(__('Back to Assignments'), 
                ['controller' => 'Sparents', 'action' => 'mykidsassignments'], 
