        ...
        <div class="content container-fluid">
         ...
         <tbody>
            ...
            <tr>
               ...
               //   }
                     //      else{
                   // echo $this->Html->link(__(' Pay With PayStack'), ['controller'=>'Students','action' => 'gotopaystack', $invoice->student_id,$invoice->fee_id,$invoice->id],
                   ...
                   // echo $this->Html->link(__(' Pay With Credo'), ['controller'=>'Students','action' => 'gotocredo', $invoice->student_id,$invoice->fee_id,$invoice->id],
                    //       ['class'=>'btn btn-round btn-info fa fa-money disabled','title'=>'pay online']); 
                   // echo $this->Html->link(__(' Pay Online Remita'), ['controller'=>'Students','action' => 'remitasplit',$invoice->id, $invoice->student_id],
                    //       ['class'=>'btn btn-round btn-info fa fa-money disabled','title'=>'pay online','style'=>'margin: 4px;']); 
