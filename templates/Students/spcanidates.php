            ...
            <fieldset>
                <div class="form-group row">
                    <div class="col-sm-4 mb-4 mb-sm-0">
                        <?php $categories = ['Yes'=>'Claretian','SP'=>'Special Candidates'];
                          echo $this->Form->control('category', ['label' => 'Select Category', 'placeholder' => 'Select Category',
                              'class' => 'form-control form-control-user2', 'options' => $categories,'empty'=>'Select Category']);
                        ?>
                    </div>
