...
<!--                            <button class="btn btn-info float-right" title="click to check your application status"
                      ...
                      <div class="text-center">
                            ...
                            <h1 class="h4 text-gray-900 mb-4"><?=SCHOOL ?> <br /> IJMB Application Form</h1>
...
?>
                                  ...
                                  <div class="col-sm-4 mb-3 mb-sm-0">
                                    <?php echo $this->Form->control('community', ['label' => 'Home Town', 'placeholder' => 'autonomous community',
                                          'class' => 'form-control form-control-user2', 'required'])
                                    ?>
                                </div> 
                                  <div class="col-sm-4 mb-3 mb-sm-0">
