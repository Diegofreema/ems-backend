<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Direct Admission</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><?= $this->Html->link(' Dashboard', ['controller' => 'Users', 'action' => 'dashboard', $this->GenerateUrl('Admin dashboard')], ['title' => 'Admin dashboard'])
                        ?></li>
                    <li class="breadcrumb-item active">Direct Admission</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <fieldset><legend>Parental Information</legend>
                            <div class="form-group row">        
                               <div class="col-sm-6 mb-3 mb-sm-0"> 
                                    <?= $this->Form->control('sparent_id', ['options' => $parents, 'label' => 'Select Parent', 'empty' => 'Select Parent', 'class' => 'select2_multiple form-control form-control-user','required']) ?>
                                </div>
                            </div>
                        </fieldset>
                        <br /> <br />
...
function handleFileUpload(input) {
    if (input.files && input.files[0]) {
        ...
        const parentDiv = input.closest('.card-body');
        const iconDiv = parentDiv.querySelector('.fa-file-pdf-o, .fa-user');
        const textDiv = parentDiv.querySelector('.text-muted');
        
        if (iconDiv) {
            iconDiv.className = 'fa fa-check-circle fa-3x text-success mb-2';
        }
        if (textDiv) {
            textDiv.textContent = `${fileName} (${fileSize}MB)`;
            textDiv.className = 'text-success';
        }
    }
}
