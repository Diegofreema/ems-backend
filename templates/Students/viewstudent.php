...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">Student Profile Details</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><?= $this->Html->link(' Dashboard', ['controller' => 'Users', 'action' => 'dashboard', $this->GenerateUrl('Dashboard')], ['title' => 'Dashboard'])
                        ?></li>
                    <li class="breadcrumb-item"><?= $this->Html->link('Student Manager', ['controller' => 'Students', 'action' => 'managestudents', $this->GenerateUrl('Student Manager')], ['title' => 'Student Manager'])
                        ?></li>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <h3 class="user-name m-t-0 mb-0"><?=$student->fname.' '.$student->lname .' '.$student->mname  ?></h3>
                                        ...
                                        <div class="staff-id">Class : <span class="text-muted"><?=$student->department->name . (!empty($student->class_arm) ? ' - ' . $student->class_arm->arm_name : '')  ?></span></div>
    ...
    <div class="tab-content">
        ...
        <div id="emp_profile" class="pro-overview tab-pane fade show active">
            <div class="row">
              ...
              echo $this->Form->postLink(__(' Delete'), ['controller'=>'Invoices','action' => 'delete',$invoice->id],
                                    ...
                                    <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Father : <?= h($student->sparent->fathersname ?? '') ?></a>
                                                <div>Phone : <?= h($student->sparent->fatherphone ?? '') ?></div>
                                            </div>
                                        </div>
                                    </li>
                                 <li>
                                        ...
                                        <div class="experience-content">
                                            <div class="timeline-content">
                                                <a href="#/" class="name">Mother : <?= h($student->sparent->mothersname ?? '') ?></a>
                                                <div>Phone : <?= h($student->sparent->motherphone ?? '') ?></div>
