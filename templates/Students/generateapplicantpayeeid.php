                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3 m-b-20">
                            <?= $this->Html->image($settings->logo, ['alt' => 'LOGO', 'class' => 'inv-logo', 'height' => 100, 'width' => 130]) ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
                            ...
                            <ul class="list-unstyled">
                                <li><h5><strong>Name: <?= ucwords($student->fname. ' ' . $student->lname . ' ' . $student->mname) ?></strong></h5></li>
                               ...
                               <!-- <li>Faculty: <?= $student->faculty->name ?></li> -->
                                <li>Class: <?= $student->department->name ?></li>
...
<!--                                 <li>City: <span>London E1 8BF</span></li>
                    ...
                    <div>
                        ...
                        <div class="invoice-info">
                            ...
                            <p class="text-muted">Please click on any of the buttons below to make payment. All applications without application fee payment will not be processed<br />
...
<?=
    $this->Html->link(__(' Pay Online (Paystack)'), ['controller' => 'Transactions', 'action' => 'gotopaystack', $student->user->username, $student->phone, $student->fname.' '.$student->lname, $transaction->amount, $student->id, $transaction->fee_id, $transaction->payref, $transaction->id],
        ['class' => 'btn btn-success float-left', 'title' => 'pay online with your ATM card'])
?>

<?=
$this->Html->link(__(' Pay Online (Credo)'), ['controller' => 'Transactions', 'action' => 'gotocredo', $student->id, $transaction->fee_id,
    $transaction->invoice_id], ['class' => 'btn btn-success float-left', 'title' => 'pay online with your ATM card'])
?>
                            <!-- link to credo payment   -->
