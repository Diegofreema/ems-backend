                ...
                <?=$this->Html->image($settings->logo, ['alt' => 'LOGO', 'class' => 'img-responsive float-left','width'=>130])?>
                           ...
                           <div class="col-sm-6" style="text-align: center">
                            <h1 class="h4 text-gray-900 mb-4"><strong style="font-size: 26px;"><?=$settings->name?></strong><br />
                                <center> <b style="font-size: 18px;">  <?=$settings->address?></b></center><br />
                               
                               <b style="font-size: 21px;"> Acceptance Letter</b></h1>
                               </div>
                            <div class="col-sm-3">
...
<br /><br /> <?= strtoupper($student->fname.' '.$student->mname.' '.$student->lname)  ?><br />
 <?=$student->address  ?>      <br />
 Application Reference Number : <?=$student->application_no ?> (You must quote this in all correspondence)<br /><br />
Dear <?= strtoupper($student->fname.' '.$student->mname.' '.$student->lname)  ?><br />
