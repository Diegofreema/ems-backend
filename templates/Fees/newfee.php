<div class="content container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="page-title">New Fee</h3>
                <ul class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Add New Fee</h1>
                        </div>
                        ...
                        <fieldset>
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                <!-- <div class="col-sm-4 mb-3 mb-sm-0">
              <?= $this->Form->control('levels._ids', ['label' => 'Select Level', 'options' => $levels,'class' => 'select2_multiple form-control form-control-user'])?>
                    </div> -->
              ...
              <?php $feetypes = ['enrolled'=>'Enrolled','none_enrolled'=>'None Enrolled'];
                echo $this->Form->control('feetype', ['options'=>$feetypes,'label' => 'Fee Type', 'class' => 'form-control form-control-user2', 'placeholder'=>'fee type'])?>
                                      ...
                                      <div class="col-sm-4 mb-3 mb-sm-0">
              <?= $this->Form->control('itemcode', ['label' => 'Item Code', 'class' => 'form-control form-control-user2',  'placeholder'=>'item code'])?>
                    </div>
                                 </div>
