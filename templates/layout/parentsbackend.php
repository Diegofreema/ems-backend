            ...
            <div class="header">
                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                            <span class="user-img">
                                <?= $this->html->image('../img/user.png', ['alt' => 'Parent']) ?>

                                <span class="status online"></span></span>
                            <span><?= ucfirst($user['lname']) ?></span>
                        </a>
                        <div class="dropdown-menu">
                            <?= $this->Html->link('My Profile', ['controller' => 'Sparents', 'action' => 'myprofile', $this->GenerateUrl('my profile')], ['title' => 'patent dashboard', 'class' => 'dropdown-item'])
                            ?>
                ...
                <div class="dropdown mobile-user-menu">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <?= $this->Html->link('My Profile', ['controller' => 'Sparents', 'action' => 'myprofile', $this->GenerateUrl('my profile')], ['title' => 'my profile', 'class' => 'dropdown-item'])
                        ?>
                        ...
                        <ul>
                            ...
                            <li>
                                <?= $this->Html->link(
                                    ...
                                    array('controller' => 'Sparents', 'action' => 'dashboard'), 
                                    array('escape' => false)
                                ) ?>
                            </li>
                            ...
                            <li>
                                <?= $this->Html->link(
                                    $this->Html->tag('i', '', array('class' => 'la la-edit')) . ' <span>My Kids Assignments</span>', 
                                    array('controller' => 'Sparents', 'action' => 'mykidsassignments'), 
                                    array('escape' => false)
                                ) ?>
                            </li>
                            ...
                            <li>
                                <?= $this->Html->link(
                                    $this->Html->tag('i', '', array('class' => 'la la-calendar-check-o')) . ' <span>Child Attendance</span>', 
                                    array('controller' => 'Sparents', 'action' => 'childattendance'), 
                                    array('escape' => false)
                                ) ?>
                            </li>
                            ...
                            <li>
                                <?= $this->Html->link(
                                    $this->Html->tag('i', '', array('class' => 'la la-file-o')) . ' <span>Check Results</span>', 
                                    array('controller' => 'Sparents', 'action' => 'mykidsresults'), 
                                    array('escape' => false)
                                ) ?>
                            </li>
                            ...
                            <li>
                                <?= $this->Html->link(
                                    $this->Html->tag('i', '', array('class' => 'la la-newspaper-o')) . ' <span>Invoices</span>', 
                                    array('controller' => 'Sparents', 'action' => 'mykidinvoices'), 
                                    array('escape' => false)
                                ) ?>
                            </li>
