...
if (!$fullBaseUrl) {
     ...
     */
    $trustProxy = (bool)Configure::read('Ems.trustProxy', false);
...
//for google single signin
define('CLIENT_ID', '24488454500-plsc9b8j27sd1kkcmu217lgu4j040itl.apps.googleusercontent.com');


//added by chukd - 10/07/2025
define('SCHOOL', 'TREASURE SCIENTIA SCHOOL, OWERRI, IMO STATE');
define('SENDMAIL', 'info@livingtempleacademy.ng');
define('PRETRANS', 'TSS');
define('INVOICEPREFIX', 'TSS');
define('TRANS_REF', 'TSS');
define('REGNOPREFIX', 'TSS');
...
//merchant ref for bank branch payment
define('ROOM_CAPACITY', 2);

//for bulk payment 165600 recurring - 176100
define('ICT_FEE', 10500);
define('ARTS_FEES', 275100-10000);
define('SCIENCE_FEES', 326700-10000);
define('ACCEPTANCE_FEE', 25000);
define('WEST_FEES', 173100); //minus ict fee 10500
...
define("TESTSERVICETYPEID", 4430731); //test 4430731
define("TESTAPIKEY", 1946); //  test key 1946
define("TESTCHECKSTATUSURL", "https://demo.remita.net/remita/exapp/api/v1/send/api/echannelsvc/");
define("TESTRRRPAYMENTURL", "https://demo.remita.net/remita/ecomm/finalize.reg");
define("TESTGATEWAYURL", "https://demo.remita.net/remita/exapp/api/v1/send/api/echannelsvc/merchant/api/paymentinit");
